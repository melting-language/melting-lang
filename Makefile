...
# Generate config.h for Makefile build if missing (CI and fresh clones).
config.h:
	@echo '/* generated by Makefile */' > config.h
	@echo '#ifndef CONFIG_H' >> config.h
	@echo '#define CONFIG_H' >> config.h
	@echo '#define PROJECT_VERSION_MAJOR 1' >> config.h
	@echo '#define PROJECT_VERSION_MINOR 3' >> config.h
	@echo '#define PROJECT_VERSION_PATCH 2' >> config.h
	@echo '#endif' >> config.h
